        ...
        <div class="cart">
          ...
          <div class="cart__item cart-item">
            <img
              ...
              src="	https://img.ostin.com/upload/mdm/media_content/resize/0f4/332_460_af80/46809030299.jpg"
              alt=""
            />
            <div class="cart-item__info">
              <h3 class="cart-item__title">Свитшот</h3>
              <p>L</p>
            </div>
            <div class="cart-item__count">
              <button class="cart-item__minus">
          ...
          <div class="cart__bottom-details">
            <span>
              Всего в корзине: <b>3 шт.</b>
            </span>
            <span>
              Сумма заказа:<b> 5000 руб.</b>
            </span>
          </div>
          <div class="cart_bottom-buttons">
            <button>
              <svg
                width="8"
                height="14"
